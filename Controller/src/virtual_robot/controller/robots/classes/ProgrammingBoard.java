 ...
 */
@BotConfig(name = "Programming Board", filename = "programming_board", disabled=false)
public class ProgrammingBoard extends VirtualBot {
    ...
    public synchronized void updateStateAndSensors(double millis){
        ...
        analogInput.updateState(millis, sldPot.getValue());
        imu.updateState(millis, headingRadians);
        colorSensor.updateState(millis, new PassiveColorSensorImpl.ColorTriple(red, green, blue));
        digitalChannel.updateState(millis, !btnTouchPushed);
        distanceSensor.updateState(millis, sldDist.getValue());
    }
