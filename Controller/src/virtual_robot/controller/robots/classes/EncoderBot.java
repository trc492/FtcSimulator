 ...
 *
 */
@BotConfig(name = "Encoder Bot", filename = "encoder_bot", disabled = false)
public class EncoderBot extends VirtualBot {
    ...
    public synchronized void updateStateAndSensors(double millis){
        ...
        rightEncoder.updateState(millis, rightEncoderRadians);
        leftEncoder.updateState(millis, leftEncoderRadians);
        xEncoder.updateState(millis, xEncoderRadians);
