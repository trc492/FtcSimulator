...
public class DcMotorImpl implements DcMotor {
    ...
    private DcMotor odometryDevice = null;
    ...
    public synchronized void setMode(RunMode mode){
        ...
        if (mode == RunMode.STOP_AND_RESET_ENCODER){
            ...
            if (odometryDevice != null) {
                odometryDevice.setMode(mode);
            }
        }
    }
    ...
    public synchronized void setPower(double power){
        // System.out.printf("Motor: %s, setPower: %f\n", this.getDeviceName(), power);
    ...
    public synchronized int getCurrentPosition(){
        if (odometryDevice!=null) {
            return odometryDevice.getCurrentPosition();
        }
    ...
    @Override
    public synchronized Object updateState(double millis, Object dummy) {
    ...
    // internal use only; set up external encoder for use as an odometry device
    public void setExternalOdometry(DcMotor odometryDevice) {
        this.odometryDevice = odometryDevice;
    }


    private String deviceId = "Undefined";
    @Override
