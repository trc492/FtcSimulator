...
public class ServoImpl implements Servo{
    static ServoController servoController = new ServoController();
    ...
    public Object updateState(double milliseconds, Object state) {
        //FIXME: currently, setPosition takes place instantly.  If we want, we can implement this method to simulate the time it takes servos to move, much like we do with motors
        return null;
    }
}
